...
Referencia oficial: https://www.elastic.co/guide/en/ecs/current
...
Una vez que el servicio esté desplegado y procesando peticiones, los logs aparecerán en Kibana en los siguientes índices:
...
public class ApiResponseWrapper {
    ...
    public static ApiResponseWrapper error(int codHttp, String codDet,
        ...
        return new ApiResponseWrapper(
            codHttp, codDet, msg, null, errors, requestId, version);
    }
...
> **NOTA:** Esta clase no usa Lombok (`@Data`) para evitar dependencias adicionales. Agregar getters/setters manualmente o agregar Lombok al `pom.xml` según la convención del proyecto.
...
## A.2 Campos ECS obligatorios en logs

  ------------------------------------------------------------------------------------
  **Campo ECS**         **Descripción**                      **Origen**
  --------------------- ------------------------------------ -------------------------
  ...
  http.request.id       X-Request-ID                         Filtro del servicio
...
## A.3 Convenciones de nomenclatura ONP
  ...
  **Concepto**         **Formato**                                   **Ejemplo**
  ...
  Índice logs DEV      onp-logs-development-\<service\>-YYYY.MM.DD   ---

  Índice logs PROD     onp-logs-production-\<service\>-YYYY.MM.DD    ---
  -------------------------------------------------------------------------------------------------------------
